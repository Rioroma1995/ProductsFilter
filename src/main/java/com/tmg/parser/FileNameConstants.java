...
public class FileNameConstants {
    ...
    static final String CATEGORY_PRODUCT = "categoryproduct";
    static final String CATEGORIES = "categories";
    static final String PRODUCT_CLASSIFICATIONS = "product_classifications";
    ...
    static final String PRODUCT_DISCLAIMER = "productdisclaimer";
}